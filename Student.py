...
def student_details1():
    ...
    def save():
        if department_combobox.get() == "Select Department" or Year_combobox.get() == "Select" or Name_entry.get() == "" or Rollno_entry.get() == "" or Divison_combobox.get() == "Select" or Gender_combobox.get() == "Select" or Mobile_entry.get() == "" or email_entry.get() == "":
    ...
    def focus_cursor():
        ...
        department_combobox.set(data[0]),
        Year_combobox.set(data[1]),
        Name_entry.insert(data[2]),
    ...
    save_button = Button(down_frame_label, text="Save", command=save, width=20, height=4,
    ...
    student1_table = ttk.Treeview(search_box_frame,
                                  column=("Dep", "year", "name", "roll no", "Divison", "Gender", "Mobile", "email"),
